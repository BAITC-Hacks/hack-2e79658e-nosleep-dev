...
func TestDemoModeNeverUsesNetworkAndIsClearlyCached(t *testing.T) {
	...
	c.demo = true
	c.apiKey = ""
	r := &scoring.Result{BudgetUsed: 95, BudgetRemaining: 5, DAvgBefore: 56.872912, DAvgAfter: 57.994788, MinDistrictID: "nura", MinDBefore: 49.18, MinDAfter: 52.9625, CriticalBefore: 2, CriticalAfter: 0}
	s := 56.485102
	r.Score = &s
